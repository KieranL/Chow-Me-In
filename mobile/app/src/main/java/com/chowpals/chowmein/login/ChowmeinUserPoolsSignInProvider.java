 ...
 */
public class ChowmeinUserPoolsSignInProvider implements SignInProvider {
    /**
    ...
    /** Log tag. */
    private static final String LOG_TAG = ChowmeinUserPoolsSignInProvider.class.getSimpleName();
    ...
    public View.OnClickListener initializeSignInButton(final Activity signInActivity,
        ...
        final UserPoolLoginView userPoolSignInView = activity.findViewById(R.id.sign_in_view);
        ...
        userPoolSignInView.getSignUpTextView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.startActivityForResult(intent, ChowmeinUserPoolsSignInProvider.SIGN_UP_REQUEST_CODE);
            }
        });
