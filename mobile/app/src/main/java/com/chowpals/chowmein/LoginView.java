...
public class LoginView extends LinearLayout {
    ...
    private static final String USER_POOL_SIGN_IN_VIEW = NAMESPACE_COMMON_PREFIX + ".UserPoolLoginView";
    ...
    public static final int DEFAULT_LOGO_IMAGE_RES_ID = com.amazonaws.mobile.auth.ui.R.drawable.default_sign_in_logo;
    ...
    private void setUpDivider(final Context context) {
         ...
         */
        if (this.config != null && this.config.getSignInUserPoolsEnabled()) {
            divider = inflate(context, com.amazonaws.mobile.auth.ui.R.layout.horizontal_or_sign_in_divider, null);
        } else {
            divider = inflate(context, com.amazonaws.mobile.auth.ui.R.layout.horizontal_sign_in_divider, null);
        }
        addView(divider);
    }
    ...
    private void setUpSignInButtons(final Context context) {
         ...
         */
        signInButtonMargin = getResources().getDimensionPixelSize(com.amazonaws.mobile.auth.ui.R.dimen.sign_in_button_margin);
        signInButtonWidth  = getResources().getDimensionPixelSize(com.amazonaws.mobile.auth.ui.R.dimen.sign_in_button_width);
        signInButtonHeight = getResources().getDimensionPixelSize(com.amazonaws.mobile.auth.ui.R.dimen.sign_in_button_height);
    ...
    private AuthUIConfiguration getConfiguration(final Context context) {
        try {
            return Application.sAuthUIConfiguration;
        } catch (Exception exception) {
            System.err.println(exception);
            return null;
        }
