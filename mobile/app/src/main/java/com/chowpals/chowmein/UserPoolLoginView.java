 ...
 */
public class UserPoolLoginView extends LinearLayout {
    ...
    public UserPoolLoginView(final Context context) {
        this(context, null);
    }

    public UserPoolLoginView(final Context context, @Nullable final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public UserPoolLoginView(final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.setOrientation(VERTICAL);
        this.setGravity(Gravity.CENTER);
        this.setId(com.chowpals.chowmein.R.id.sign_in_view);
    ...
    private void initializeIfNecessary() {
        ...
        try {
            ...
            signInManager.initializeSignInButton(ChowmeinUserPoolsSignInProvider.class, signInButton);
    ...
    private void setupCredentialsForm(final Context context) {
        ...
        userNameEditText = credentialsFormView.addFormField(context,
                ...
                context.getString(R.string.login_username));
    ...
    private void setupSignInButton(final Context context) {
        ...
        final LinearLayout.LayoutParams signInButtonLayoutParams = new LinearLayout.LayoutParams(
                ...
                resources.getDimensionPixelSize(com.amazonaws.mobile.auth.userpools.R.dimen.sign_in_button_height));
    ...
    private void setupLayoutForSignUpAndForgotPassword(final Context context) {
        ...
        signUpTextView.setGravity(Gravity.CENTER_HORIZONTAL);
...
//        layoutForSignUpAndForgotPassword.addView(forgotPasswordTextView, layoutParamsForForgotPassword);
    ...
    private void setupBackgroundColor(final Activity activity) {
        ...
        this.backgroundColor = (int) (intent.getIntExtra(ChowmeinUserPoolsSignInProvider.AttributeKeys.BACKGROUND_COLOR,
    ...
    private void setupFontFamily(final Activity activity) {
        Intent intent = activity.getIntent();
        this.fontFamily = (String) (intent.getStringExtra(ChowmeinUserPoolsSignInProvider.AttributeKeys.FONT_FAMILY));
    ...
    private void setupBackgroundColorFullScreen(final Activity activity) {
        ...
        this.isBackgroundColorFullScreenEnabled = (boolean) (intent.getBooleanExtra(
                ChowmeinUserPoolsSignInProvider.AttributeKeys.FULL_SCREEN_BACKGROUND_COLOR, false));
    }
